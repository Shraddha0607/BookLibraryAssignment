...
import com.example.JavaAssignment.validation.ISBNValidationService;
...
public class BookService {
    ...
    public String addBook(Book book) {
        ...
        // check the isbn validity
        String isbn = book.getIsbn();
        if(!isbnValidationService.isValidISBN(isbn)){
            return "Invalid ISBN! Kindly enter valid ISBN.";
        }
